...
const APP = {
  ...
  sheets: {
    // ── Ручные (начало процесса) ──
    PRODUCTS:         '1️⃣ Товары',
    PLANNING:         '2️⃣ Планирование',
    SEWING_LAUNCH:    '3️⃣ Запуск ШВ',
    SEWING_OUTPUT:    '4️⃣ Выпуск ШВ',
    FULFILLMENT:      '5️⃣ Фуллфилмент',
    // ── API-загружаемые ──
    ARTICLES:         '📦 Артикулы',
    ARTICLE_BARCODES: '🔗 Баркоды',
    SUPPLIES:         '🚚 Поставки',
    SUPPLY_DETAILS:   '🚚 Поставки детали',
    ORDERS:           '🛒 Заказы',
    SALES:            '💰 Продажи',
    AD_EXPENSES:      '📣 Реклама',
    // ── Расчётные ──
