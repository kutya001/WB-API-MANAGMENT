...
- Интеграция с WB API (написание кода на Python, JS, GAS)
...
```
Что нужно?
├─ Написать интеграцию       → §1 Определи домен + §3 Шаблон кода + web_fetch для параметров
...
Подробные шаблоны клиентов для Python, JavaScript и Google Apps Script: [code-templates.md](./references/code-templates.md)
...
| 403 | Доступ запрещён | Токен от удалённого пользователя или заблокирован |
...
|---|---|---|---|---|
| Marketplace (заказы) | 1 мин | 300 | 200 мс | 20 |
